...
def create_server(call_tool):
    ...
    server.instructions = (
        ...
        'get_units lists units; get_unit reads one selected unit. get_journal reads reflections '
        'for a selected class. get_discussions reads posts and replies for one task. '
